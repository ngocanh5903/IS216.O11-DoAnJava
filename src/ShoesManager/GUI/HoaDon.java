...
public class HoaDon extends javax.swing.JFrame  implements MouseListener{
    ...
    private void initComponents() {
        ...
        lblThongTin_ThongTin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ShoesManager/images/Button Menu/210_70/Thông tin.png")));
        ...
        lblThongTin_TimKiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ShoesManager/images/Button Menu/210_70/Tìm kiếm.png")));
        ...
        tblThongTin.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HĐ", "Mã KH", "Mã NV", "Ngày Bán", "Tổng tiền"
            }
        ) {
        ...
        calendarThongTin.setDate(new java.util.Date(System.currentTimeMillis()));
        ...
        pThongTinLayout.setHorizontalGroup(
            ...
            .addGroup(pThongTinLayout.createSequentialGroup()
                .addGroup(pThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pThongTinLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblThongTin_ThongTin, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tfThongTin_MaHDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfThongTin_MaHDMouseClicked
        // TODO add your handling code here:
        System.out.println("Click here Please");
    ...
    /**
     * tong tien = tong tien + So Luong * Gia Ban
     * @param iSoLuong
     * @param iGiaBan
    ...
    private void btnChiTiet_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChiTiet_ThemActionPerformed
        ...
        if (cachamquantrong.kiemTraDuLieuSo(tfChiTiet_SL.getText()))
            if(kiemTraHangHoa())
                ...
                JOptionPane.showMessageDialog(null, "Số lượng tồn kho không đủ", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void lblChiTiet_3chamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblChiTiet_3chamMouseClicked
        ...
        tfChiTiet_Gia.setText(Memory.giaSP);
